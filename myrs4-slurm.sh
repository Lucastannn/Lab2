...
DPT.objects.processDirs(dirs=None, objtype=pyh.RPLSplit, channel=[*range97,125)]); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:208048781676:awsnotify --message "Rs4_done"
